...
#define tdefl_compress my_tdefl_compress
#define tdefl_compress_buffer my_tdefl_compress_buffer
#define tdefl_init my_tdefl_init
#define tdefl_get_prev_return_status my_tdefl_get_prev_return_status
#define tdefl_get_adler32 my_tdefl_get_adler32
#define tdefl_compress_mem_to_output my_tdefl_compress_mem_to_output
#define tdefl_compress_mem_to_heap my_tdefl_compress_mem_to_heap
#define tdefl_compress_mem_to_mem my_tdefl_compress_mem_to_mem
#define tdefl_create_comp_flags_from_zip_params my_tdefl_create_comp_flags_from_zip_params
#define tdefl_write_image_to_png_file_in_memory_ex my_tdefl_write_image_to_png_file_in_memory_ex
#define tdefl_write_image_to_png_file_in_memory my_tdefl_write_image_to_png_file_in_memory
#define tinfl_decompress my_tinfl_decompress
#define tinfl_decompress_mem_to_heap my_tinfl_decompress_mem_to_heap
#define mz_adler32 my_mz_adler32
#define mz_crc32 my_mz_crc32
#define mz_free my_mz_free
#define mz_zip_reader_init_file my_mz_zip_reader_init_file
#define mz_zip_reader_init my_mz_zip_reader_init
#define mz_zip_reader_init_mem my_mz_zip_reader_init_mem
#define mz_zip_reader_end my_mz_zip_reader_end
#define mz_zip_reader_extract_file_to_heap my_mz_zip_reader_extract_file_to_heap
